...
async def async_setup_entry(hass: HomeAssistant, entry: ConfigEntry) -> bool:
    ...
    if not domain_data.get("view_registered"):
        hass.http.register_view(HermesMindCloudDataView(hass, base_path))
    ...
    await async_register_panel(
        ...
        module_url=f"{STATIC_URL}/hermes-mind-cloud-panel.js?v=0.1.34",
        config={
            "api_url": API_URL,
    ...
    domain_data[entry.entry_id] = {"base_path": base_path}
    return True
